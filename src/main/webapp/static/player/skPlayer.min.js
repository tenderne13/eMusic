	...
	([function (t, e, n) {
				...
				var s = {
					leftDistance : function (t) {
						for (var e = t.offsetLeft, n = void 0; t.offsetParent; )
							t = t.offsetParent, e += t.offsetLeft;
				...
				l = function () {
					function t(e) {
						var n = this;
						if (o(this, t), i)
							return console.error("SKPlayer只能存在一个实例！"), Object.create(null);
						i = !0;
						var r = {
					...
					return r(t, [{
								...
								value : function () {
									...
									this.dom.musiclist.addEventListener("click", function (e) {
										...
										o = void 0,
										r = void 0;
										if ("LI" === e.target.tagName.toUpperCase())
											n = e.target;
										else {
											if ("LI" !== e.target.parentElement.tagName.toUpperCase())
												return;
					...
					for (var n = 0; n < t.length; n++) {
						...
						if (r) {
							...
							for (; s < o.parts.length; s++)
								r.parts.push(u(o.parts[s], e))
						} else {
							for (var i = [], s = 0; s < o.parts.length; s++)
								i.push(u(o.parts[s], e));
							y[o.id] = {
								id : o.id,
								refs : 1,
								parts : i
				...
				function s(t, e) {
					...
					var o = P[P.length - 1];
					if ("top" === t.insertAt)
						o ? o.nextSibling ? n.insertBefore(e, o.nextSibling) : n.appendChild(e) : n.insertBefore(e, n.firstChild), P.push(e);
					else {
				...
				function u(t, e) {
					...
					if (e.singleton) {
						...
						t.sourceMap && "function" == typeof URL && "function" == typeof URL.createObjectURL && "function" == typeof URL.revokeObjectURL && "function" == typeof Blob && "function" == typeof btoa ? (n = l(e), o = h.bind(null, n, e), r = function () {
							i(n),
				...
				function h(t, e, n) {
					...
					(e.convertToAbsoluteUrls || s) && (o = g(o)),
